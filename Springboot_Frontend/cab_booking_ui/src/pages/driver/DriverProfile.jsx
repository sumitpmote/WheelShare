...
function DriverProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // API call to create/update driver profile
      success("Driver profile updated successfully!");
    } catch (error) {
      console.error(error);
      showError("Error while updating driver profile");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="card" style={{ padding: '2rem' }}>
            <div className="flex flex-col gap-md">
              ...
              <div style={{
                ...
                <div>Make sure all information is accurate. Your profile will be verified by our team.</div>
              </div>
