...
export const confirmCashPayment = (rideId) =>
  api.post(`/driver/confirm-cash-payment/${rideId}`, {});

export const getPendingCashConfirmations = () =>
  api.get("/driver/pending-cash-confirmations");