    ...
    <div className="home-page">
        ...
        <div className="container" style={{ maxWidth: '800px', position: 'relative', zIndex: 2 }}>
          ...
          >
            <h1 style={{ 
              ...
              Safe, Reliable & Real-Time<br />Cab Booking
            </h1>
            ...
            <p style={{ 
              ...
              Experience seamless cab booking with verified drivers and real-time tracking.
            </p>
      ...
      <div className="container">
        <div style={{ 
          ...
          {[
            { number: `${stats.totalUsers}+`, label: "Happy Customers", icon: <Users size={20} /> },
      ...
      <div className="container">
        ...
        <div style={{ 
          ...
          {[
            { step: "1", title: "Sign Up", desc: "Create your account as customer or driver" },,
            { step: "2", title: "Book/Accept", desc: "Book a cab or accept booking requests" },,
      ...
      <div className="container">
        ...
        <div style={{ 
          ...
          >
            ...
            <p style={{ color: 'var(--text-muted)', marginBottom: '1.5rem', lineHeight: 1.6 }}>
              Explore our cab booking services, features, and benefits for both customers and drivers
            </p>
            <a style={{ color: 'var(--primary)', fontWeight: 600, textDecoration: 'none' }}>
              Explore Services →
            </a>
        ...
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          >
            ...
            <p style={{ 
              ...
              Start your journey with thousands of satisfied customers and drivers
            </p>
            <button 
              onClick={() => navigate("/register")} 
              className="btn"
