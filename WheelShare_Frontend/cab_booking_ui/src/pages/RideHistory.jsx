...
import { Car, MapPin, Navigation, Clock, Filter, Calendar, Loader, Receipt as ReceiptIcon } from "lucide-react";
...
function RideHistory() {
  ...
  const handleViewReceipt = async (rideId) => {
    setReceiptLoading(true);
    try {
      const response = await getReceipt(rideId);
            ...
            filteredRides.map((ride, index) => (
              ...
              >
                ...
                {ride.rideStatus === "COMPLETED" && (
                  <button
                    onClick={() => handleViewReceipt(ride.rideId)}
